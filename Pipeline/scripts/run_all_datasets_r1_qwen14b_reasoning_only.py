"""Re-Guide ablation launcher (Qwen-14B): reasoning-guide ONLY.
...
Examples:
    ...
    python run_all_datasets_r1_qwen14b_reasoning_only.py --gpus 6,7 --retriever_gpus 0,1

    # single dataset on one GPU
    python run_all_datasets_r1_qwen14b_reasoning_only.py --gpus 3 --retriever_gpus 0,1 --dataset musique
"""
import os
import sys
