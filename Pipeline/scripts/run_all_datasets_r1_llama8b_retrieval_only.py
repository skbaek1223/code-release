"""Re-Guide ablation launcher (Llama-8B): retrieval-guide ONLY.
...
Examples:
    ...
    python run_all_datasets_r1_llama8b_retrieval_only.py --gpus 6,7 --retriever_gpus 0,1

    # single dataset on one GPU
    python run_all_datasets_r1_llama8b_retrieval_only.py --gpus 6 --retriever_gpus 0,1 --dataset nq,ambigqa
"""
import os
import sys
