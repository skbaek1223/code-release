"""Re-Guide ablation launcher (Qwen3-4B): reasoning-guide ONLY.
...
Inherits all defaults from run_all_datasets_qwen3_4b.py. Output directories
...
Examples:
    ...
    python run_all_datasets_qwen3_4b_reasoning_only.py --gpus 6,7 --retriever_gpus 0,1

    # single dataset on one GPU
    python run_all_datasets_qwen3_4b_reasoning_only.py --gpus 3 --retriever_gpus 0,1 --dataset musique
"""
import os
import sys

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import run_all_datasets_qwen3_4b  # noqa: E402,F401  (imports for side effects)
