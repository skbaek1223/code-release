"""Re-Guide ablation launcher (QwQ-32B): reasoning-guide ONLY.
...
Examples:
    ...
    python run_all_datasets_qwq32b_reasoning_only.py --gpus 2,3 --retriever_gpus 0,1

    # parallel (two independent 2-GPU workers)
    python run_all_datasets_qwq32b_reasoning_only.py --parallel \\
